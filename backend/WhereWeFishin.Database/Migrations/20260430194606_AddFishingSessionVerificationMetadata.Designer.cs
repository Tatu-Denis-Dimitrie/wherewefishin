...
namespace WhereWeFishin.Database.Migrations
{
    ...
    [Migration("20260430194606_AddFishingSessionVerificationMetadata")]
    partial class AddFishingSessionVerificationMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhereWeFishin.Core.Entities.ImageAnalysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("DominantConfidence")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("WhereWeFishin.Core.Entities.ManagerApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AdministrationBasis")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<int?>("ApprovedFishingSpotId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ProposedPricePerHour")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.HasIndex("ApprovedFishingSpotId");
            ...
            modelBuilder.Entity("WhereWeFishin.Core.Entities.ManagerApplication", b =>
                {
                    b.HasOne("WhereWeFishin.Core.Entities.User", "ApplicantUser")
                        .WithMany()
                        .HasForeignKey("ApplicantUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WhereWeFishin.Core.Entities.FishingSpot", "ApprovedFishingSpot")
                        .WithMany()
                        .HasForeignKey("ApprovedFishingSpotId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("WhereWeFishin.Core.Entities.User", "ReviewedByAdmin")
                        .WithMany()
                    ...
                    b.Navigation("ApprovedFishingSpot");
