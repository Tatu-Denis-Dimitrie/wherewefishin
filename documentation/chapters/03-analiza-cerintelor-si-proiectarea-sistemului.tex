...
Figura~\ref{fig:diagrama-clase} prezintă o diagramă simplificată a claselor principale, cu atributele cheie ale fiecărei entități. Fiecare entitate conține și câmpuri auxiliare gestionate transparent de infrastructură (timestamp de creare, flag de ștergere logică), excluse din reprezentare pentru claritate. Constrângerile de integritate referențială declarate la nivelul bazei de date completează relațiile vizuale din diagramă, garantând consistența datelor independent de stratul aplicativ.
